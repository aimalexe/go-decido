...
This project is a hands-on way to learn Go: packages, structs, methods, interfaces, errors, CLI input, menus, and table-driven tests. Expect more concepts as the app grows.
...
| `internal/service` | Orchestration + `Store` interface |
